// ⬇ ⬇ ⬇ New script that sort of works with the json server but i need to sort out... ⬇ ⬇ ⬇ //
// ⬇ ⬇ ⬇ (thanks to Sergio for taking time to explain / help me with the JSON serer)..⬇ ⬇ ⬇ //
// ⬇ ⬇ ⬇ ... all the bugs including why load more characters now doesn't work along with... ////
// ⬇ ⬇ ⬇ ➡ on page load have a fetch to load favourites so they are not lost..............///
// ⬇ ⬇ ⬇ ➡ sorting out the delete button..................................................///
// ⬇ ⬇ ⬇ ➡ when searching I need the 'more characters' button at the bottom to load.......///
// ⬇ ⬇ ⬇ ... more of the characters that were searched not a new page of characters.........///
// ⬇ ⬇ ⬇ ➡ and finally clearing the bloody search bar which i can't work out how to clear ///
...
//   return state.character.find(function (character) {
...
//         })
//         .then(function (obj) {
//           state.favourites.push(obj.charId);
//         });
//     }
//   });
...
//   // ⬇ Need to change the below to use Fetch Json DELETE ⬇ //
...
//   for (const character of state.character) {
...
//   for (const characterId of state.favourites) {
...
//         mainElement.innerHTML = "";
//         state.character = characters.results;
...
//       })
//       .then(function (characters) {
//         state.character.push(characters);
...
// ⬇ ⬇ ⬇ old code that sort of works but not with the json server ⬇ ⬇ ⬇ //
